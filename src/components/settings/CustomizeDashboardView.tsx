  ...
  const modulesList: ModuleItem[] = [
    {
      ...
      descKey: 'modDashboardDesc',
      defaultName: 'Dashboard',
      defaultDesc: 'Business overview, real-time analytics & key performance metrics',
      icon: Layers,
      category: 'operations',
    },
    {
    ...
    },
    {
      ...
      nameKey: 'modPos',
      descKey: 'modPosDesc',
      defaultName: 'POS & Sell',
      defaultDesc: 'Full point-of-sale counter register with receipts and scanning',
      icon: ShoppingBag,
      category: 'sales',
    },
    {
    ...
    },
    {
      ...
      nameKey: 'modCapitalInvestment',
      descKey: 'modCapitalInvestmentDesc',
      defaultName: 'Capital & Investment',
      defaultDesc: 'Track owner investments and capital withdrawals separately from sales & profit',
      icon: Coins,
      category: 'finance',
    },
    {
    ...
    },
    {
      ...
      descKey: 'modStoreSettingsDesc',
      defaultName: 'Store Settings',
      defaultDesc: 'Business profile, branding logo, receipt config & printer setup',
      icon: Store,
      category: 'operations',
    },
    {
      key: 'dashboardCustomization',
      nameKey: 'customizeDashboard',
      descKey: 'modDashboardCustomizationDesc',
      defaultName: 'Dashboard Customization',
      defaultDesc: 'Configure visible features, modules, quick sales & UI layout',
